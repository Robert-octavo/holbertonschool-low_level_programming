...
<ul>
<li><a title="File descriptors" href="https://intranet.hbtn.io/rltoken/zwnc2vqfmCs_ZThsyxkjJw" target="_blank">File descriptors</a></li>
<li><a title="C Programming in Linux Tutorial #024 - open() read() write() Functions" href="https://intranet.hbtn.io/rltoken/Ig_LMzPlXTT-EwoSAgYK-Q" target="_blank">C Programming in Linux Tutorial #024 - open() read() write() Functions</a></li>
</ul>
...
<p>At the end of this project, you are expected to be able to <a title="explain to anyone" href="https://intranet.hbtn.io/rltoken/P0824k6np2sTua7wMdZL-Q" target="_blank">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
<h3>General</h3>
<ul>
